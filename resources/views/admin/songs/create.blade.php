                ...
                <form id="addSongForm" action={{route('admin.songs.store')}} method="POST" enctype="multipart/form-data">
                    ...
                    {{-- <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" id="artist" required>
                                ...
                                <option value="son-tung-mtp">Sơn Tùng M-TP</option>
                                <option value="dangrangto">Dangrangto</option>
                                <option value="chi-pu">Chi Pu</option>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle"></i> Thêm bài hát
                        </button>
                    </div>
                </form>
            </div>
